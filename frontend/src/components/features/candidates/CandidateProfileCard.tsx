    ...
    return (
        <div className="glass-card p-6 flex flex-col md:flex-row gap-8">
            ...
            <div className="flex flex-col flex-1">
                <div className="flex justify-between items-start mb-6">
                    <div className="flex gap-4 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-brand-lavender font-medium">{candidate.role}</p>
                        </div>
                    </div>

                    <div className="flex flex-col items-end">
                        <span className="text-xs text-white/50 uppercase tracking-widest font-semibold mb-1">Match Score</span>
                        <div className="flex items-center gap-2">
                            <Star className={cn("w-5 h-5", candidate.matchScore >= 90 ? "text-emerald-400 fill-emerald-400" : "text-amber-400 fill-amber-400")} />
                            <span className="text-3xl font-bold text-white">{candidate.matchScore}</span>
                        </div>
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-white/70 mb-6 border-y border-white/5 py-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <a href="#" className="hover:text-white transition-colors">GitHub Profile</a>
                    </div>
                    <div className="flex items-center gap-3">
                ...
                <div>
                    <h3 className="font-semibold text-white mb-2 text-sm uppercase tracking-wider">AI Extracted Summary</h3>
                ...
                <div>
                    <h3 className="font-semibold text-white mb-3 text-sm uppercase tracking-wider">Top Skills</h3>
                    <div className="flex flex-wrap gap-2">
                        {candidate.skills.map(skill => (
                            <span key={skill} className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs text-brand-lavender font-medium">
                                {skill}
                            </span>
                        ))}
                    </div>
