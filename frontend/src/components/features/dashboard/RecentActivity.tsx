    ...
    return (
        <div className="glass-card p-6 min-h-[400px]">
            <div className="flex justify-between items-center mb-6">
                ...
                <button className="text-sm text-brand-lavender hover:text-white transition-colors">View All</button>
            </div>
                    ...
                    return (
                        <div key={item.id} className="relative pl-4">
                            ...
                            {idx !== activities.length - 1 && (
                                <div className="absolute left-[1.35rem] top-10 bottom-[-1.5rem] w-[1px] bg-white/10" />
                            )}

                            <div className="flex gap-4">
                                <div className={cn("mt-1 w-8 h-8 rounded-full flex items-center justify-center shrink-0 border border-white/5 shadow-glow-sm", item.bgType)}>
