...
const getMeetTab = getActiveCallTab;
      ...
      <div className="hl-popup__glass">
        ...
        <div className="hl-popup__landing">
          ...
          <p className="hl-popup__landing-sub">
            Open a video call (Google Meet, Zoom, Teams) and use the HireLens sidebar to create a new interview — upload JD + Resume and AI generates tailored questions instantly.
          </p>
